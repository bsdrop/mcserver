...
public final class GPUSurfacePrecomputer {
    ...
    public static final boolean DENSITY_ENABLED =
        !"false".equalsIgnoreCase(System.getProperty("canvas.gpu.density.enabled", "true")); // Claude - default ON
    ...
    private static final boolean INTERP_ENABLED = !"false".equalsIgnoreCase(System.getProperty("canvas.gpu.interp", "true")); // Claude - default ON
